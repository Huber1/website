...
Moritz Huber  
IT Services & 3d-Druck (Einzelunternehmer)  
Walliserstraße 106  
81475 München

## Kontakt

Telefon: <Base64 client:only encoded="KzQ5ICgwKSAxNTEgNTY1IDMzIDEyMQ==" /><br />
E-Mail: <Base64 client:only encoded="aXRAbW9yaXR6aHViZXIuZGU=" />

## Umsatzsteuer-ID

Umsatzsteuer-Identifikationsnummer gemäß &sect; 27 a Umsatzsteuergesetz:<br /><Base64 client:only encoded="REUzNjYzNDA5NTc=" />
...
[https://ec.europa.eu/consumers/odr]. Unsere E-Mail-Adresse finden Sie oben im
Impressum.
...
Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gew&auml;hrleisten. Andere Daten k&ouml;nnen zur Analyse Ihres
...
Hetzner).
Details entnehmen Sie der Datenschutzerkl&auml;rung von Hetzner: [https://www.hetzner.com/de/rechtliches/datenschutz].
Die Verwendung von Hetzner
erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an einer m&ouml;glichst
...
keine anderen rechtlich zul&auml;ssigen Gr&uuml;nde f&uuml;r die Speicherung
...
DSGVO verarbeitet werden. Im Falle einer ausdr&uuml;cklichen Einwilligung in
die &Uuml;bertragung personenbezogener Daten in Drittstaaten erfolgt die
Datenverarbeitung au&szlig;erdem auf Grundlage von Art. 49 Abs. 1 lit. a
...
Durchf&uuml;hrung vorvertraglicher Ma&szlig;nahmen erforderlich, verarbeiten
wir Ihre Daten auf Grundlage des Art. 6 Abs. 1 lit. b DSGVO. Des Weiteren
verarbeiten wir Ihre Daten, sofern diese zur Erf&uuml;llung einer rechtlichen
...
Einzelfall einschl&auml;gigen Rechtsgrundlagen wird in den folgenden
...
Daten unserer Kunden nur auf Grundlage eines g&uuml;ltigen Vertrags &uuml;ber
...
sind kleine Datenpakete und richten auf Ihrem Endger&auml;t keinen Schaden an.
...
zur Bereitstellung bestimmter, von Ihnen erw&uuml;nschter Funktionen
...
Verarbeitung ausschlie&szlig;lich auf Grundlage dieser Einwilligung (Art. 6
Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG); die Einwilligung ist
...
Welche Cookies und Dienste auf dieser Website eingesetzt werden, k&ouml;nnen
Sie dieser Datenschutzerkl&auml;rung entnehmen.
...
(Art. 6 Abs. 1 lit. a DSGVO) sofern diese abgefragt wurde; die Einwilligung
